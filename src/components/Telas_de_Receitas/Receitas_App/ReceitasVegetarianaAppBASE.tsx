...
type Props = NativeStackScreenProps<TiposRotas, 'ReceitasVegetarianaAppBASE'>

export default function ReceitasVegetarianaAppBASE({navigation}: Props) {
  return (
    <ImageBackground
    ...
    className="flex-1">
      <View className="flex-1 p-4">
        ...
        <Pressable onPress={() => navigation.navigate('ReceitasVegetarianaApp')} className="mx-4 mb-20 items-center">
