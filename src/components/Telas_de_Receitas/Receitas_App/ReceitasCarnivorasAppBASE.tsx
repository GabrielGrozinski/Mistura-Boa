...
type Props = NativeStackScreenProps<TiposRotas, 'ReceitasCarnivoraAppBASE'>

export default function ReceitasCarnivoraAppBASE({navigation}: Props) {
  return (
    <ImageBackground
    ...
    className="flex-1">
      <View className="flex-1 p-4">
        ...
        <Pressable onPress={() => navigation.navigate('ReceitasCarnivoraApp')} className="mx-4 mb-20 items-center">
